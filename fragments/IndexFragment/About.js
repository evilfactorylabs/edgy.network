  ...
  return (
    <div className='text-white'>
      ...
      <p className='_font-secondary leading-relaxed mb-5'>
        ...
        a premium service called{' '}
        <Link href='/plus'>
          <a>edgy+</a>
        </Link>{' '}
        to make the project more sustainable, to show love, and to support me in
        further research related to this domain. You can{' '}
        <Link href='/plus'>
          <a>click here</a>
        </Link>{' '}
        to learn more about edgy+ in case you didn't click on the link above.
      </p>
      <p className='_font-secondary leading-relaxed mb-5'>
