  ...
  return (
    <footer className='text-white pt-5 pb-7 leading-relaxed lg:w-8/12 border-t-2 border-transparent'>
      <p className='leading-relaxed text-xs tracking-tighter'>
        ...
        <a href='https://umami.is/docs/tracker-config'>respects</a> your{' '}
        <a href='https://allaboutdnt.com/'>Do-Not-Track (DNT)</a> preferences.
      </p>
      <p className='_font-secondary text-xs opacity-0'>Jayalah Indonesiaku</p>
    </footer>
  )
}
